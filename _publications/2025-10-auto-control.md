...
<img src="{{ site.baseurl }}/images/Automatic-control(5).jpg" alt="Automatic-control(5)" style="display:block; margin:0 auto 1rem auto; max-width:100%; width:660px; height:auto;" />
