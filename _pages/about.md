...
I have extensive experience in **open-source flight controller secondary development (PX4-based)**, including **control logic modification, middleware communication, and hardware閳ユ悞oftware co-debugging**. My work also includes **flight dynamics modeling and simulation**, which I use to validate control strategies before deployment on real hardware.
